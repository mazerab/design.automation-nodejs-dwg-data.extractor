...
function statusCallback(completed, message) {
  ...
  $('#exportXLS').prop("disabled", !completed);
}
...
XLSExtension.prototype.load = function () {
  ...
  createUI = function () {
    ...
    button1.onClick = function (e) {
        ForgeXLS.exportXLS(documentId, projectId, itemId, fileName, token, statusCallback, fileType); /*Optional*/
    };
    button1.addClass('toolbarXLSButton');
    button1.setToolTip('Export to .XLS');
